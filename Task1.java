...
public class Task1 {
    ...
    public static int[] Sort(int[] array1) {
        ...
        int[] result = SortNums(buffer1, buffer2, 0, array1.length);
        return result;
    }

    public static int[] SortNums(int[] buffer1, int[] buffer2,
        ...
        int[] sort1 = SortNums(buffer1, buffer2, startIndex, middle);
        int[] sort2 = SortNums(buffer1, buffer2, middle, endIndex);
